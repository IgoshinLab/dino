...
def get_args_parser():
    ...
    # Misc
    parser.add_argument('--data_path', default='/mnt/data/feature_extraction/imgnet_more/', type=str,
        help='Please specify path to the ImageNet training data.')
    parser.add_argument('--output_dir', default="/mnt/data/feature_extraction/ckpts/", type=str, help='Path to save logs and checkpoints.')
